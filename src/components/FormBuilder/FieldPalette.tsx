        ...
        <div className="grid grid-cols-2 gap-3">
          {basicFields.map((field) => {
            ...
            return (
              ...
              >
                <span className="flex size-5 items-center justify-center rounded border border-border bg-muted text-foreground transition-transform group-hover:scale-110">
